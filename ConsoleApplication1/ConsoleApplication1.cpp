...
void screen(const char*)
{
	...
	drawstring(290, 425, 0.0, "     GLOBAL ACADEMY OF TECHNOLOGY   ", 1); //first argument width second height
	...
	drawstring(440, 300, 0.0, "SIMULATION OF MOTION OF SATELLITE AROUND THE PLANET", 1);
	glColor3f(1.0, 0.0, 0.0);
	drawstring(135, 205, 0.0, " STUDENT NAME", 0);
	glColor3f(0.0, 0.0, 0.0);
	drawstring(140, 170, 0.0, "Nidhishree.D.S", 0);
	drawstring(140, 135, 0.0, "1GA19CS099", 0);
	glColor3f(1.0, 0.0, 0.0);
